...
<div class="container-wrap">
	...
	<?php 
	$query = $pdo->query("SELECT * FROM eventos where departamento = '$id_departamento' and ativo = 'Sim' and banner != 'sem-foto.jpg' order by id desc limit 4");
	...
	if($total_reg > 0){
									...
									<div class="col-md-6 col-md-offset-3 text-center" >
										<div class="slider-text"> 
											<div class="slider-text-inner">
												...
												<h5 style="display:<?php echo $ocultar_subtitulo ?>" class="pcarac"><?php echo $subtitulo ?></h5>
			...
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2">
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-6 text-center">
							<span class="fh5co-counter js-counter" data-from="0" data-to="<?php echo $total_departamentos ?>" data-speed="1000" data-refresh-interval="50"></span>
		...
		<div id="fh5co-services" class="fh5co-light-grey">
			<div class="row animate-box">
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
					<h2>Eventos</h2>
					<p>Confira os próximos e os últimos eventos de nosso Departamento! </p>
				</div>
			</div>
			<div class="row">

				<?php 
						$query = $pdo->query("SELECT * FROM eventos where departamento = '$id_departamento' and ativo = 'Sim' and tipo = 'Evento' order by  data_evento desc, id desc limit 3");
						$res = $query->fetchAll(PDO::FETCH_ASSOC);
						$total_reg = count($res);
						if($total_reg > 0){
							for($i=0; $i < $total_reg; $i++){
		...
		<div id="fh5co-sermon">
			...
			<div class="row">
				...
				<?php 
						$query = $pdo->query("SELECT * FROM eventos where departamento = '$id_departamento' and ativo = 'Sim' and tipo = 'Pregação' order by data_evento desc, id desc limit 3");
						$res = $query->fetchAll(PDO::FETCH_ASSOC);
						$total_reg = count($res);
						if($total_reg > 0){
							for($i=0; $i < $total_reg; $i++){
			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					<div class="row animate-box">
						...
						<?php 
							$query = $pdo->query("SELECT * FROM versiculos where departamento = '$id_departamento' order by id desc limit 15");
						$res = $query->fetchAll(PDO::FETCH_ASSOC);
						$total_reg = count($res);
						if($total_reg > 1){
							echo $total_reg;							 
		...
		<div id="fh5co-news" class="fh5co-light-grey">
			...
			<div class="row">
				<?php 
						$query = $pdo->query("SELECT * FROM eventos where departamento = '$id_departamento' and ativo = 'Sim' and tipo = 'Evento' and data_evento < curDate() order by  data_evento desc, id desc limit 4");
						$res = $query->fetchAll(PDO::FETCH_ASSOC);
						$total_reg = count($res);
						if($total_reg > 0){
							for($i=0; $i < $total_reg; $i++){
