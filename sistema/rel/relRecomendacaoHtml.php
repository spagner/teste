...
$departamento_rec = $_GET['departamento'];
$id = $_GET['id'];
$obs = $_GET['obs'];
...
$query = $pdo->query("SELECT * FROM diretores where id = '$diretor_departamento'");
$res = $query->fetchAll(PDO::FETCH_ASSOC);
...
<body>
	...
	<section class="area-cab">
		<div class="cabecalho">
			...
			<div align="right" class="coluna" style="width:50%"> <img style="margin-top:5px" src="<?php echo $url_sistema ?>img/departamentos/<?php echo $imagem_departamento ?>" width="30px"> <?php echo mb_strtoupper($nome_departamento) ?></div>
	...
	<section class="area-cab">
		<div class="cabecalho">
			...
			<div align="right" class="coluna" style="width:40%"><small> <small><small> <?php echo $end_departamento ?></small></small></small></div>
		</div>
	</section>
	...
	<?php }else{ ?>
		...
		<img class="imagem" src="<?php echo $url_sistema ?>img/departamentos/<?php echo $cabecalho_rel ?>">
	<?php } ?>
	...
	<div style="margin:20px">
		...
		Apresentamos a <?php echo $nome_departamento ?> localizada em <?php echo $end_departamento ?>!</small></p>
	</div>
	...
	<div style="margin:20px">
		<p><small>
			Por se achar em comunhão com este departamento, nós o(a) recomendamos, para que o(a) recebais no Senhor, como usam fazer os Santos.
		</small></p>
	</div>
	...
	<div align="center" style="margin-top:-10px">
		<p><small>
			<b>CONGREGAÇÃO: <?php echo mb_strtoupper($departamento_rec) ?></b>
		</small></p>
	</div>

	<div align="center" style="margin:20px">
		<p><small>
			Pela <?php echo $nome_departamento ?>, na data de <u><?php echo date('d/m/Y'); ?></u>
		</small></p>
	</div>
