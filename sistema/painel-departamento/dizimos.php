...
<div class="col-md-12 my-3">
	<a href="#" onclick="inserir()" type="button" class="btn btn-dark btn-sm">Nova Contribuição</a>
</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="mb-3">
								...
								<input type="text"  class="form-control" id="valor" name="valor" placeholder="Valor do Dizimo" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="mb-3">
