...
if(@$_GET['departamento'] > 0){
	@$_SESSION['id_departamento'] = @$_GET['departamento'];
}

$id_departamento = @$_SESSION['id_departamento'];

//TRAZER OS DADOS Do departamento
$query = $pdo->query("SELECT * FROM departamentos where id = '$id_departamento'");
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
			<a class="navbar-brand" href="painel-admin"><img src="../img/departamentos/<?php echo $foto_departamento ?>" width="40px" height="40px"></a>
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							<li><a class="dropdown-item" href="index.php?pag=requerentes">Requerente</a></li>
							<li><a class="dropdown-item" href="index.php?pag=beneficiados">Beneficiado</a></li>
							<li><hr class="dropdown-divider"></li>
							
							
							<li><a class="dropdown-item <?php echo $esc_tesoureiro ?> <?php echo $esc_secretario ?>" href="index.php?pag=secretarios">Secretários</a></li>
							<li><a class="dropdown-item <?php echo $esc_tesoureiro ?> <?php echo $esc_secretario ?>" href="index.php?pag=diretores">Diretores</a></li>
							<li><a class="dropdown-item <?php echo $esc_tesoureiro ?> <?php echo $esc_secretario ?>" href="index.php?pag=operadores">Operador</a>
							</li>
							<li><a class="dropdown-item  <?php echo $esc_secretario ?>" href="index.php?pag=visitadores">Visitadores</a>
							</li>
							<li><hr class="dropdown-divider"></li>
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<li><a class="dropdown-item <?php echo $esc_tesoureiro ?>" href="index.php?pag=departamentos">Dados do Departamento</a></li>
							
							<li><a class="dropdown-item <?php echo $esc_tesoureiro ?>" href="index.php?pag=cultos">Encontros</a></li>
					...
					<li class="nav-item dropdown <?php echo $esc_secretario ?>">
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<li><a class="dropdown-item" href="index.php?pag=dizimos">Contribuição (Dízimos)</a></li>
			...
			<form method="post" action="../rel/relMembros.php" target="_blank">
				<div class="modal-body">
					<div class="row">
						...
						<input type="hidden" name="departamento" value="<?php echo $id_departamento ?>">
					</div>
