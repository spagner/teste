		...
		<div class="modal-content">
			...
			<form id="form" method="post">
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="mb-3">
								...
								<input type="text" class="form-control" id="nome" name="nome" placeholder="Bairro do Grupo Caseiro" required>
							</div>
						</div>
						<div class="col-md-4">
							<div class="mb-3">
					...
					<div class="mb-3">
								<label for="exampleFormControlInput1" class="form-label">Local da Reunião </label>
