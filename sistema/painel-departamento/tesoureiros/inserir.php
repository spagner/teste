...
if($id == "" || $id == 0){
	...
	$query = $pdo->prepare("INSERT INTO usuarios SET nome = :nome, email = :email, cpf = :cpf, senha = '123@mudar', nivel = 'tesoureiro', id_pessoa = '$ult_id', foto = '$imagem', departamento = '$id_departamento'");
