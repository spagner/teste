...
<div class="tabela bg-light">
	...
	$query = $pdo->query("SELECT * FROM $pagina where id != 1 and departamento = '$id_departamento' order by id desc");
			...
			<tbody>
				...
				for($i=0; $i < $total_reg; $i++){
					...
					<tr>
						...
						<td>
							<a href="#" onclick="editar('<?php echo $id ?>', '<?php echo $nome ?>', '<?php echo $cpf ?>', '<?php echo $email ?>', '<?php echo $telefone ?>', '<?php echo $endereco ?>', '<?php echo $foto ?>', '<?php echo $data_nasc ?>', '<?php echo $departamento ?>', '<?php echo $nome_ig ?>')" title="Editar Registro">	<i class="bi bi-pencil-square text-primary"></i> </a>

							<a href="#" onclick="excluir('<?php echo $id ?>' , '<?php echo $nome ?>')" title="Excluir Registro">	<i class="bi bi-trash text-danger"></i> </a>
							<a href="#" onclick="dados('<?php echo $nome ?>', '<?php echo $cpf ?>', '<?php echo $email ?>', '<?php echo $telefone ?>', '<?php echo $endereco ?>', '<?php echo $foto ?>', '<?php echo $data_nascF ?>', '<?php echo $data_cadF ?>', '<?php echo $nome_ig ?>')" title="Ver Dados">	<i class="bi bi-info-square-fill text-primary"></i> </a>
...
<script type="text/javascript">
	...
	function editar(id, nome, cpf, email, telefone, endereco, foto, data_nasc, departamento, nome_ig){
		$('#id').val(id);
		$('#nome').val(nome);
		$('#email').val(email);
		$('#cpf').val(cpf);
	...
	function dados(nome, cpf, email, telefone, endereco, foto, data_nasc, data_cad, departamento){
