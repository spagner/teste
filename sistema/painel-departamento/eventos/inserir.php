...
if($id == "" || $id == 0){
	$query = $pdo->prepare("INSERT INTO $pagina SET titulo = :titulo, subtitulo = :subtitulo, descricao1 = :descricao1, descricao2 = :descricao2, descricao3 = :descricao3, data_cad = curDate(), data_evento = '$data_evento', usuario = '$id_usuario', video = :video, ativo = 'Sim', departamento = '$departamento', imagem = '$imagem', tipo = '$tipo', banner = '$banner', url = '$url', pregador = :pregador, titulo_banner = '$titulo_banner', data_banner = '$data_banner', link_banner = '$link_banner', video_banner = '$video_banner', subtitulo_banner = '$subtitulo_banner'");
...
$query->execute();
	...
	if($imagem == "sem-foto.jpg"){
		$query = $pdo->prepare("UPDATE $pagina SET titulo = :titulo, subtitulo = :subtitulo, descricao1 = :descricao1, descricao2 = :descricao2, descricao3 = :descricao3, data_cad = curDate(), data_evento = '$data_evento', usuario = '$id_usuario', video = :video, ativo = 'Sim', departamento = '$departamento', tipo = '$tipo', url = '$url', pregador = :pregador, titulo_banner = '$titulo_banner', data_banner = '$data_banner', link_banner = '$link_banner', video_banner = '$video_banner', subtitulo_banner = '$subtitulo_banner' where id = '$id'");
...
$query->execute();
		...
		$query = $pdo->prepare("UPDATE $pagina SET titulo = :titulo, subtitulo = :subtitulo, descricao1 = :descricao1, descricao2 = :descricao2, descricao3 = :descricao3, data_cad = curDate(), data_evento = '$data_evento', usuario = '$id_usuario', video = :video, ativo = 'Sim', departamento = '$departamento', imagem = '$imagem', tipo = '$tipo', url = '$url', pregador = :pregador, titulo_banner = '$titulo_banner', data_banner = '$data_banner', link_banner = '$link_banner', video_banner = '$video_banner', subtitulo_banner = '$subtitulo_banner' where id = '$id'");
...
$query->execute();
		...
		$query = $pdo->prepare("UPDATE $pagina SET titulo = :titulo, subtitulo = :subtitulo, descricao1 = :descricao1, descricao2 = :descricao2, descricao3 = :descricao3, data_cad = curDate(), data_evento = '$data_evento', usuario = '$id_usuario', video = :video, ativo = 'Sim', departamento = '$departamento', banner = '$banner', tipo = '$tipo', url = '$url', pregador = :pregador, titulo_banner = '$titulo_banner', data_banner = '$data_banner', link_banner = '$link_banner', video_banner = '$video_banner', subtitulo_banner = '$subtitulo_banner' where id = '$id'");
