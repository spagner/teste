		...
		<table id="example" class="table table-striped table-light table-hover my-4 my-4" style="width:100%">
			...
			<tbody>
				...
				for($i=0; $i < $total_reg; $i++){
					...
					$res_con = $query_con->fetchAll(PDO::FETCH_ASSOC);
					if(count($res_con) > 0){
						$nome_departamento = $res_con[0]['nome'];
						$foto_departamento = $res_con[0]['imagem'];
					...
					<tr>
						<td>
							<img src="../img/departamentos/<?php echo $foto_departamento ?>" width="25px">
							<?php echo $nome_departamento ?>
