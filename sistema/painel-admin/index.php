...
$res = $query->fetchAll(PDO::FETCH_ASSOC);
$email_dept = $res[0]['email'];
$nome_dept = $res[0]['nome'];
$end_dept = $res[0]['endereco'];
$tel_dept = $res[0]['telefone'];
...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid">
			<a class="navbar-brand" href="#"><img src="../img/logo-icone.png" width="50px"></a>
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<li><a class="dropdown-item" href="index.php?pag=diretores">Diretores</a></li>
							<li><a class="dropdown-item" href="index.php?pag=operadores">Operadores</a></li>
							<li><a class="dropdown-item" href="index.php?pag=visitadores">Visitadores</a></li>
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<li><a class="dropdown-item" href="index.php?pag=departamentos">Departamentos</a></li>
							
							<li><a class="dropdown-item" href="index.php?pag=cargos">Cargos</a></li>
...
<!--
				...
				<div class="d-flex mx-4">
					<img class="img-profile rounded-circle" src="../img/funcionarios/<?php echo $foto_usu ?>" width="40px" height="40px">
					...
					<ul class="navbar-nav ">
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
								<li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#modalPerfill">Editar Dados</a></li>
...
<div class="modal fade" id="modalPerfill" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div id="divImg" class="mt-4">
									<img src="../img/funcionarios/<?php echo $foto_usu ?>"  width="100px" id="target-usu">									
								</div>
							</div>
						</div>
			...
			<form id="form-config" method="post">
				<div class="modal-body">
					<div class="row">
						<div class="col-md-4">
							<div class="mb-3">
								<label for="exampleFormControlInput1" class="form-label">Nome Departamento</label>
								<input type="text" class="form-control form-control-sm" id="nome_dept" name="nome_dept" placeholder="Nome do Departamento" value="<?php echo $nome_dept ?>" required>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="mb-3">
								<label for="exampleFormControlInput1" class="form-label">Email Departamento</label>
								<input type="email" class="form-control form-control-sm" id="email_dept" name="email_dept" placeholder="Insira o Email Departamento" value="<?php echo $email_dept ?>" required>
							</div>
						</div>

						<div class="col-md-4">
							<div class="mb-3">
								<label for="exampleFormControlInput1" class="form-label">Telefone Departamento</label>
								<input type="text" class="form-control form-control-sm" id="tel_dept" name="tel_dept" placeholder="Telefone do Departamento" value="<?php echo $tel_dept ?>" required>
							</div>
						</div>
					</div>
					...
					<div class="row">
							...
							<div class="mb-3">
								<label for="exampleFormControlInput1" class="form-label">Endereço Departamento</label>
								<input type="text" class="form-control form-control-sm" id="end_dept" name="end_dept" placeholder="Endereço do Departamento" value="<?php echo $end_dept ?>" required>
							</div>
					...
					<div class="row">
						<div class="col-md-3">
							<div class="mb-3">
								...
								<input type="number" class="form-control form-control-sm" id="qtd_tar_dept" name="qtd_tar_dept" value="<?php echo $quantidade_tarefas ?>" required>
							</div>
						</div>
						<div class="col-md-3">
							<div class="mb-3">
								<label for="exampleFormControlInput1" class="form-label">Limitar Operadores</label>
								<select class="form-select form-select-sm" name="limitar_operador">
									<option <?php if($limitar_operador == 'Sim'){ ?>selected <?php } ?> value="Sim">Sim</option>
									<option <?php if($limitar_operador == 'Não'){ ?>selected <?php } ?> value="Não">Não</option>
								</select>
							</div>
						</div>
				...
				<div class="modal-body">
					<div class="row">
							...
							<div class="mb-3">
									...
									<select class="selmem" aria-label="Default select example" name="departamento" style="width:100%">  
										
										<?php 
									$query = $pdo->query("SELECT * FROM departamentos order by id asc");
									$res = $query->fetchAll(PDO::FETCH_ASSOC);
									$total_reg = count($res);
									if($total_reg > 0){
			...
			<form method="post" action="../rel/relPatrimonio.php" target="_blank">
				<div class="modal-body">
					<div class="row">
							...
							<div class="mb-3">
									<label for="exampleFormControlInput1" class="form-label">Departamento</label>
									<select class="selpat" aria-label="Default select example" name="departamento" style="width:100%">  
						...
						<div class="col-md-3">
							<div class="mb-3">
									...
									<select class="form-select form-select-sm" aria-label="Default select example" name="itens">  
										<option value="">Todos</option>
										<option value="1">Pertencentes ao Departamento</option>
										<option value="2">Emprestados a Outros</option>
										<option value="3">Itens de Outros Departamentos</option>
									</select>
								</div>
						</div>
			...
			<form method="post" action="../rel/relFinanceiro.php" target="_blank">
				<div class="modal-body">
					<div class="row">
							...
							<div class="mb-3">
									<label for="exampleFormControlInput1" class="form-label">Departamento</label>
									<select class="selfin" aria-label="Default select example" name="departamento" style="width:100%">  
						...
						<div class="col-md-3">
							<div class="mb-3">
									...
									<select class="form-select form-select-sm" aria-label="Default select example" name="tabelas" id="tabelas">  
										...
										<option value="visitadores">Visitadores</option>
