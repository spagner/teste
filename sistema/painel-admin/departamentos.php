...
<div class="col-md-12 my-3">
	<a href="#" onclick="inserir()" type="button" class="btn btn-dark btn-sm">Novo Departamento</a>
</div>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="mb-3">
								...
								<select class="form-control sel2" id="diretor" name="diretor" style="width:100%;">
									<?php 
...
<div class="modal fade" id="modalImagens" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel"><span id="tituloModal">Imagens do Departamento <span id="nome-imagem"></span></span></h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
...
<script type="text/javascript">
	...
	function editar(id, nome, telefone, endereco, foto, diretor, video, email, url, youtube, instagram, facebook, descricao, prebenda){
	...
	function dados(nome, telefone, endereco, foto, data_cad, matriz, diretor, email, descricao, prebenda){
