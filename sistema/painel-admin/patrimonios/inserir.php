...
if($id == "" || $id == 0){
	$query = $pdo->prepare("INSERT INTO $pagina SET codigo = :codigo, nome = :nome, descricao = :descricao, valor = :valor, usuario_cad = '$id_usuario', data_cad = '$data_cad', departamento_cad = '$departamento', departamento_item = '$departamento', ativo = 'Sim', entrada = '$entrada', doador = :doador, foto = '$imagem'");
