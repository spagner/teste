...
if($id == "" || $id == 0){
	...
	$query = $pdo->prepare("INSERT INTO usuarios SET nome = :nome, email = :email, cpf = :cpf, senha = '123@mudar', nivel = 'secretario', id_pessoa = '$ult_id', foto = '$imagem', departamento = '$id_departamento'");
	...
	if($imagem == "sem-foto.jpg"){
	$query = $pdo->prepare("UPDATE usuarios SET nome = :nome, email = :email, cpf = :cpf where id_pessoa = '$id' and nivel = 'secretario'");
}else{
	$query = $pdo->prepare("UPDATE usuarios SET nome = :nome, email = :email, cpf = :cpf, foto = '$imagem' where id_pessoa = '$id' and nivel = 'secretario'");
}
