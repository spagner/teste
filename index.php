...
$query = $pdo->query("SELECT * FROM departamentos where matriz = 'Sim'");
$res = $query->fetchAll(PDO::FETCH_ASSOC);
if(@count($res) > 0){

$nome_departamento = $res[0]['nome'];
$foto_departamento = $res[0]['imagem'];
$endereco_departamento = $res[0]['endereco'];
$telefone_departamento = $res[0]['telefone'];
$youtube = $res[0]['youtube'];
$instagram = $res[0]['instagram'];
$facebook = $res[0]['facebook'];
$id_departamento = $res[0]['id'];
$diretor_id = $res[0]['diretor'];
$video_departamento = $res[0]['video'];
$email_departamento = $res[0]['email'];
$descricao_departamento = $res[0]['descricao'];

$query = $pdo->query("SELECT * FROM diretores where id = '$diretor_id'");
$res = $query->fetchAll(PDO::FETCH_ASSOC);
$diretor_resp = $res[0]['nome'];
}
 ?>
<!DOCTYPE html>
<html>
    			...
    			<div class="container">
        			<div class="row align-items-center">
            			<div class="col-auto">
                			...
                			<p class="navbar-text text-secondary ml-10" style="overflow: visible;"><?php echo $nome_departamento_sistema ?></p>
            			</div>
            			...
            			<div class="col-lg-auto navbar-collapse main-menu-collapse mr-auto position-inherit collapse" style="">
                			<ul class="navbar-nav" style="">
                    			...
                    			<li class="nav-item">
                        			<a class="nav-link sub-menu-link" href="#" style=""><strong><span class="text-uppercase">CIAPD</span><svg xmlns="http://www.w3.org/2000/svg" height="16" viewBox="0 0 16 16" width="16" class="icon icon-pos-right svg-secondary"><path d="m8 11 4-5h-8z" fill-rule="evenodd"></path></svg></strong></a>
                        			<ul class="sub-menu bg-default">
                                    	...
                                    	$query = $pdo->query("SELECT * FROM departamentos order by matriz desc, nome asc");
                                    		...
                                    		for($i=0; $i < $total_reg; $i++){
                                    			...
                                    			$url = $res[$i]['url'];
                                    	 ?>
                            			<li class=""><a href="departamento<?php echo $url ?>"><?php echo $nome ?></a></li>
                            			<?php } ?>                           			
			...
			<header id="header-carousel" class="section-carousel overall text-center dark carousel-nav-none carousel-dots-right-bottom pt-0">
    			<div class="carousel-single carousel-stretch owl-drag">
                    ...
                    if($subtitulo_banner != ""){
						...
						$query2 = $pdo->query("SELECT * FROM departamentos where id = '$departamento'");
            			...
            			<div class="container">
                			<div class="row">
                    			<div class="col" style="">
                        			...
                        			<h2 class="mt-sm-75"><strong style="color:#383838"><?php echo $titulo ?></strong></h2><h4 class="mt-sm-75" style="color:#383838"><strong class="">Departamento em <?php echo $nome_ig ?></strong></h4>
                                    </div>
    			...
    			<div class="container">
        			<div class="row">
            			...
            			<div class="col-12" style="">
                			<h2 class="text-center mt-sm--30" style="">Centro Integrado de Atenção à Pessoa com Deficiência</h2>
              			<p class="text-center mt-20 mb-50 mb-sm-30" style="">Modelo inspirador para nós, foi marcada pela comunhão profunda, pelo poder do Espírito Santo e por uma evangelização audaciosa.</p>
            			...
            			<div class="col-12">
                			<div class="carousel-3item pb-50 owl-drag">
                				...
                				<div class="item gallery-item rounded gallery-style-1 border-x2 padding"><a href="index2.html" target="_self" class="smooth">
                        			...
                        			</a><a class="btn mb-md-0 text-center btn-sm btn-block smooth btn-outline-dark fx-btn-pill mt-30" href="departamento<?php echo $url ?>" style="" target="_self">Visitar Site<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 448 512" class="icon icon-pos-right" srcset=""><path d="M190.5 66.9l22.2-22.2c9.4-9.4 24.6-9.4 33.9 0L441 239c9.4 9.4 9.4 24.6 0 33.9L246.6 467.3c-9.4 9.4-24.6 9.4-33.9 0l-22.2-22.2c-9.5-9.5-9.3-25 .4-34.3L311.4 296H24c-13.3 0-24-10.7-24-24v-32c0-13.3 10.7-24 24-24h287.4L190.9 101.2c-9.8-9.3-10-24.8-.4-34.3z"></path></svg></a></div>
                        			<div class="item-icon">
    			...
    			<div class="container">
        			<div class="row">
            			...
            			<div class="col-12 ml-auto mr-auto" style="">
                			<h2 class="text-center mb-10 mt--30 mt-sm-0" style="">Eventos Gerais</h2><p style="" class="mb-50 text-center">Nossos últimos eventos destacados aqui!<br></p>
                			<div class="carousel-3item pb-50 owl-drag">
